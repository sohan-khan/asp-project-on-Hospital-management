...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <center><h1>Category Insert</h1></center>
    <br />
    ...
    <div class="table table-bordered table-striped table-responsive-xl">
         <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataSourceID="ObjectDataSource2" DefaultMode="Insert" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" GridLines="Both" Width="1100px">
