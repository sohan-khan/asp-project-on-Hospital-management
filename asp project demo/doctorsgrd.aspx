...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="doctorId" DataSourceID="SqlDataSource1" PageSize="5" ShowFooter="True" Width="1266px">
        <Columns>
            ...
            <asp:TemplateField HeaderText="deptId" SortExpression="deptId">
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlDept" CssClass="form-control" runat="server" SelectedValue='<%# Bind("deptId") %>' DataSourceID="SqlDataSource2" DataTextField="deptname" DataValueField="deptId" AutoPostBack="True"></asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:hmdbCon %>" SelectCommand="SELECT * FROM [departments]"></asp:SqlDataSource>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlDept" runat="server" ValidationGroup="Insert" Text="*" ErrorMessage=" depId Field Required"></asp:RequiredFieldValidator>

                </EditItemTemplate>
            
                <FooterTemplate>
                    
                    <asp:DropDownList ID="ddlDepts" CssClass="form-control" runat="server"  SelectedValue='<%# Bind("deptId") %>' DataSourceID="SqlDataSource2" DataTextField="deptname" DataValueField="deptId" AutoPostBack="True"></asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:hmdbCon %>" SelectCommand="SELECT * FROM [departments]"></asp:SqlDataSource>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="ddlDepts" runat="server" ValidationGroup="Insert" Text="*" ErrorMessage=" depId Field Required"></asp:RequiredFieldValidator>
                </FooterTemplate>
                <ItemTemplate>
   ...
   <%-- <div class="row">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO [doctors] ([doctorId], [doctorname], [doctorfee], [deptId]) VALUES (@doctorId, @doctorname, @doctorfee, @deptId)" SelectCommand="select ds.deptname,d.* from doctors d inner join departments ds on d.deptId=ds.deptId" UpdateCommand="UPDATE [doctors] SET [doctorname] = @doctorname, [doctorfee] = @doctorfee, [deptId] = @deptId WHERE [doctorId] = @doctorId">
        <DeleteParameters>
